...
function listBuyers() {
  ...
  xhr.open("GET", "https://api.zoop.ws/v1/marketplaces/" + marketplace + "/buyers", false, key);
  xhr.send(false);
...
function deleteBuyer(buyer_id){
  ...
  xhr.open("DELETE", "https://api.zoop.ws/v1/marketplaces/" + marketplace + "/buyers/" + buyer_id, false, key);
  xhr.send(false);
