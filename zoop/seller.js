...
function add_seller(data, marketplace, authuser) {
  ...
  xhr.open("POST", "https://api.zoop.ws/v1/marketplaces/" + marketplace + "/sellers/businesses", false);
...
function list_sellers(marketplace, authuser) {
  ...
  xhr.open("GET", "https://api.zoop.ws/v1/marketplaces/" + marketplace + "/sellers", false);
  xhr.setRequestHeader("Authorization", "Basic " + btoa(authuser+":"));
  xhr.send(false);
...
function search_seller_by_id(seller_id, marketplace, authuser) {
  ...
  var xhr = new XMLHttpRequest();
  xhr.withCredentials = true;
  xhr.open("GET", "https://api.zoop.ws/v1/marketplaces/" + marketplace + "/sellers/" + seller_id, false);
  xhr.setRequestHeader("Authorization", "Basic " + btoa(authuser+":"));
  xhr.send(false);
...
function delete_seller_by_id(seller_id, marketplace, authuser) {
  ...
  var xhr = new XMLHttpRequest();
  xhr.withCredentials = true;
  xhr.open("DELETE", "https://api.zoop.ws/v1/marketplaces/" + marketplace + "/sellers/" + seller_id, false);
  xhr.setRequestHeader("Authorization", "Basic " + btoa(authuser+":"));
  xhr.send(false);
